...
local function Yb()
	...
	if ic then
        ...
        tp(CFrame.new(136.667511, 18.5636292, 1352.01721))
        wait(10)
		ic = not S
		gb("Robbery started!")
		local jc = 0
...
local function cc()
	...
	if ic then
		...
		Jb()
		gb("Selling...")
		tp(CFrame.new(2286.67114, 19.1927166, -2080.41528, 0.999894977, 2.60326927e-10, 0.0144938128, -2.627637e-10, 1, 1.66221661e-10, -0.0144938128, -1.70012643e-10, 0.999894977))
		wait(1)
